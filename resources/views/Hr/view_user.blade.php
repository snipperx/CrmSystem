            ...
            <div class="profile-header">
                ...
                <div class="profile-header-content">
                    ...
                    <div class="profile-header-img">
                        <img src="{{ (!empty($users->profile_pic)) ? Storage::disk('local')->url("avatars/$users->profile_pic") : 'avatars/m-silhouette.jpg' }}"
                            alt="" >
                    </div>
                    ...
                    <div  class="col-md-12 profile-header-info">
                        ...
                        <h2 class="m-t-10 m-b-5">{{ (!empty($users->fullname)) ? $users->fullname : '' }}</h2>
                        <h6 class="text-muted">Team / Department</h6>
                        <h6 class="text-muted">{{ (!empty($users->positions)) ? $users->positions : ''}}</h6>
                        <h4 class="m-t-10 m-b-5"> Employee ID : {{ (!empty($users->employee_number)) ? $users->employee_number : ''}}</h4>
                        <h6 class="text-muted"> Date Joined : {{ (!empty($users->date_joined)) ? date(' d M Y', $users->date_joined) :'' }}</h6>
...
&lt;/span&gt;</code></pre>
        ...
        @include('Hr.partials.profileInfo')
        @endsection
