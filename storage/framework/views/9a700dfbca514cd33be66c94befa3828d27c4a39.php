    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo e(route('add_contacts')); ?>"
                    ...
                    <div class="panel-body">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="company_name" name="company_name"
                                           value="<?php echo e(($companyDetails) ? $companyDetails->company_name : ''); ?>"
                                           placeholder=Company Name">
                                </div>
                            </div>
                        </div>
                        <div class="form-group<?php echo e($errors->has('full_company_name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="full_company_name"
                                           ...
                                           value="<?php echo e(($companyDetails) ? $companyDetails->full_company_name : ''); ?>"
                        ...
                        <div class="form-group<?php echo e($errors->has('header_name_bold') || $errors->has('header_name_regular') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="header_name_bold"
                                           ...
                                           value="<?php echo e(($companyDetails) ? $companyDetails->header_name_bold : ''); ?>"
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="header_name_regular"
                                           ...
                                           value="<?php echo e(($companyDetails) ? $companyDetails->header_name_regular : ''); ?>"
                        ...
                        <div class="form-group<?php echo e($errors->has('header_acronym_bold') || $errors->has('header_acronym_regular') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="header_acronym_bold"
                                           ...
                                           value="<?php echo e(($companyDetails) ? $companyDetails->header_acronym_bold : ''); ?>"
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="header_acronym_regular"
                                           ...
                                           value="<?php echo e(($companyDetails) ? $companyDetails->header_acronym_regular : ''); ?>"
                        ...
                        <div class="form-group<?php echo e($errors->has('company_logo') ? ' has-error' : ''); ?>">
                            ...
                            <?php if( $companyDetails && !empty($companyDetails->company_logo_url) ): ?>
                                <div class="col-sm-5" style="margin-bottom: 10px;">
                                    <img src="<?php echo e($companyDetails->company_logo_url); ?>"
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <select class="form-control selectpicker" style="width: 100%;"
                                        ...
                                        <option value="blue" <?php echo e(($companyDetails && 'blue' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Blue
                                        </option>
                                        <option value="black" <?php echo e(($companyDetails && 'black' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Black
                                        </option>
                                        <option value="purple" <?php echo e(($companyDetails && 'purple' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Purple
                                        </option>
                                        <option value="green" <?php echo e(($companyDetails && 'green' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Green
                                        </option>
                                        <option value="red" <?php echo e(($companyDetails && 'red' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Red
                                        </option>
                                        <option value="yellow" <?php echo e(($companyDetails && 'yellow' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Yellow
                                        </option>
                                        <option value="blue-light" <?php echo e(($companyDetails && 'blue-light' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Blue Light
                                        </option>
                                        <option value="black-light" <?php echo e(($companyDetails && 'black-light' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Black Light
                                        </option>
                                        <option value="purple-light" <?php echo e(($companyDetails && 'purple-light' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Purple Light
                                        </option>
                                        <option value="green-light" <?php echo e(($companyDetails && 'green-light' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Green Light
                                        </option>
                                        <option value="red-light" <?php echo e(($companyDetails && 'red-light' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Red Light
                                        </option>
                                        <option value="yellow-light" <?php echo e(($companyDetails && 'yellow-light' == $companyDetails->sys_theme_color) ? ' selected' : ''); ?>>
                                            Yellow Light
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="form-group<?php echo e($errors->has('mailing_name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="mailing_name" name="mailing_name"
                                           value="<?php echo e(($companyDetails) ? $companyDetails->mailing_name : ''); ?>"
                                           placeholder="Mailing Name">
                                </div>
                            </div>
                        </div>
                        <div class="form-group<?php echo e($errors->has('mailing_address') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" id="mailing_address" name="mailing_address"
                                           value="<?php echo e(($companyDetails) ? $companyDetails->mailing_address : ''); ?>"
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" id="support_email" name="support_email"
                                           value="<?php echo e(($companyDetails) ? $companyDetails->support_email : ''); ?>"
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="company_website" name="company_website"
                                           value="<?php echo e(($companyDetails) ? $companyDetails->company_website : ''); ?>"
                                           placeholder="Company Website ">
                                </div>
                            </div>
                        </div>
                        <div class="form-group<?php echo e($errors->has('password_expiring_month') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="password_expiring_month"
                                           ...
                                           value="<?php echo e(($companyDetails) ? $companyDetails->password_expiring_month : ''); ?>"
                                           placeholder="Password Duration (Months)... ">
                                </div>
                            </div>
                        </div>
                        <div class="form-group<?php echo e($errors->has('login_background_image') ? ' has-error' : ''); ?>">
