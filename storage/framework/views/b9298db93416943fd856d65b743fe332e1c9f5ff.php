	...
	<ul class="navbar-nav navbar-right">
		...
		<li class="dropdown navbar-user">
			...
			<ul class="dropdown-menu dropdown-menu-right">
				<li><a href="<?php echo e(url('/profile')); ?>" class="dropdown-item">Edit Profile</a></li>
				<li href="javascript:;" class="dropdown-item"><span class="badge badge-danger pull-right">2</span> Inbox</li>
				<li href="javascript:;" class="dropdown-item">Calendar</li>
				<li><a href="<?php echo e(url('/settings')); ?>" class="dropdown-item">Setting</a></li>
