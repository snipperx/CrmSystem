    ...
    <div class="profile-content">
            ...
            <div class="profile-header">
                ...
                <div class="profile-header-content">
                    ...
                    <div class="profile-header-img">
                        <img src="<?php echo e((!empty($users->profile_pic)) ? Storage::disk('local')->url("avatars/$users->profile_pic") : 'avatars/m-silhouette.jpg'); ?>"
                            alt="" >
                    </div>
                    <!-- END profile-header-img -->
                    <!-- BEGIN profile-header-info -->

                    <div  class="col-md-12 profile-header-info">
                        <div class="container">
                            <h1>
                                <a href="#"  id="profile_info" class="btn btn-default btn-icon btn-circle btn-lg pull-right"
                                   data-toggle="modal" data-target="#profile_info-modal">
                                    <i class="fas fa-pencil-alt fa-fw"></i>
                                </a>
                            </h1>
                        </div>
                        <h2 class="m-t-10 m-b-5"><?php echo e((!empty($users->fullname)) ? $users->fullname : ''); ?></h2>
                        <h6 class="text-muted">Team / Department</h6>
                        <h6 class="text-muted"><?php echo e((!empty($users->positions)) ? $users->positions : ''); ?></h6>
                        <h4 class="m-t-10 m-b-5"> Employee ID : <?php echo e((!empty($users->employee_number)) ? $users->employee_number : ''); ?></h4>
                        <h6 class="text-muted"> Date Joined : <?php echo e((!empty($users->date_joined)) ? date(' d M Y', $users->date_joined) :''); ?></h6>
                ...
                <ul class="profile-header-tab nav nav-tabs">
                    <li class="nav-item"><a href="#profile-main" class="nav-link active" data-toggle="tab">Profile</a></li>
        ...
        <div class="profile-content">
            ...
            <div class="tab-content p-0">
                ...
                <div class="tab-pane fade show active" id="profile-main">
                    <!-- begin row -->
                    <div class="row">
                        <!-- begin col-6 -->
                        <div class="col-lg-6">
...
&lt;/span&gt;</code></pre>
                            ...
                            <div class="timeline-body">
                                ...
                                <div class="timeline-content">
                                    <p class="lead">
                                        ...
                                        Quisque sed varius nisl. Nulla facilisi. Phasellus consequat sapien sit amet
                                        nibh molestie placerat. Donec nulla quam, ullamcorper ut velit vitae, lobortis
                            ...
                            <div class="timeline-body">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p>In hac habitasse platea dictumst. Pellentesque bibendum id sem nec faucibus.
                                        Maecenas molestie, augue vel accumsan rutrum, massa mi rutrum odio, id luctus
                                        mauris nibh ut leo.</p>
                                    <p class="m-t-20">
                    ...
                    <div class="table-responsive">
                        <table class="table table-profile">
                            ...
                            <tr>
                                ...
                                <td><i class="fa fa-mobile fa-lg m-r-5"></i> +1-(847)- 367-8924 <a href="javascript:;"
                                                                                                   class="m-l-5">Edit</a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr class="highlight">
                                ...
                                <td class="p-t-10 p-b-10">
                                    ...
                                    <button type="submit"
                                            class="btn btn-white btn-white-without-border width-150 m-l-5">Cancel
                                    </button>
                                </td>
                            </tr>
                            </tbody>
        ...
        <?php echo $__env->make('Hr.partials.profileInfo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.default', ['contentFullWidth' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gift/GiftedSpace/crm/resources/views/Hr/view_user.blade.php ENDPATH**/ ?>